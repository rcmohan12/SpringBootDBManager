...
//	Map<String, List<String>> tableColMap;
	Map<String, List<ColumnProperties>> tableColMap;
	...
	public Map<String, List<ColumnProperties>> getTableColMap() {
		return tableColMap;
	}
	public void setTableColMap(Map<String, List<ColumnProperties>> tableColMap) {
